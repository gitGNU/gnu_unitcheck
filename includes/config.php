...
//defined('SITE_ROOT') ? null : define('SITE_ROOT', 'C:' . DS . 'xampp' . DS . 'htdocs' . DS . 'sitetester');
// SITE_ROOT in linux
defined('SITE_ROOT') ? null : define('SITE_ROOT', DS . 'opt' . DS . 'lampp' . DS . 'htdocs' . DS . 'sitetester');
...
defined('DB_NAME') ? null : define('DB_NAME', 'sitetester');
